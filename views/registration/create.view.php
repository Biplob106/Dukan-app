...
<body class="h-full bg-gray-900">
    <div class=" flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Register in to your account
            </h2>
        </div>
            ...
            <form action="/register" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <?php if (isset($errors['name'])):?><p class="text-red-600"><?=$errors['name']?>
                        </p>
                        <?php endif ?>
                    </div>
                </div>

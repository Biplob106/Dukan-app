              ...
              <form method="POST" action="/employee">
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="date_of_birth" value="<?= htmlspecialchars($old['date_of_birth'] ?? '') ?>" class="form-control">
                        <p class="error"><?= $errors['date_of_birth'] ?? '' ?></p>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInput" class="form-label">NID</label>
                        <input type="text" name="nid_bc	" value="<?php echo htmlspecialchars($old['nid_bc	'] ?? '')?>"
                     ...
                     <div class="mb-3">
                        ...
                        <input type="date" name="date_of_joining" value="<?= htmlspecialchars($old['date_of_joining'] ?? '') ?>" class="form-control">
                        <p class="error"><?= $errors['date_of_joining'] ?? '' ?></p>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Salary</label>
                        <input type="number" step="0.01" name="salary" value="<?= htmlspecialchars($old['salary'] ?? '') ?>" class="form-control">
                        <p class="error"><?= $errors['salary'] ?? '' ?></p>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Night Salary</label>
                        <input type="number" step="0.01" name="night_salary" value="<?= htmlspecialchars($old['night_salary'] ?? '') ?>" class="form-control">
                        <p class="error"><?= $errors['night_salary'] ?? '' ?></p>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInput" class="form-label">Fequency</label>
                        <input type="text" name="frequency	" value="<?php echo htmlspecialchars($old['frequency	'] ?? '')?>"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="advance_salary" value="<?= htmlspecialchars($old['advance_salary'] ?? '') ?>" class="form-control">

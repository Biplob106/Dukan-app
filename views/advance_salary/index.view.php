...
<main class="app-main">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="/advance_salary">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Advance Salary</li>
                    </ol>
                </div>
            </div>
            <!--end::Row-->
    ...
    <div class="app-content">
        ...
        <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
                <a href="/advance_salary/create">
                    <span> Add Advance_salary</span> </a>
            ...
            <table border="1" cellpadding="10" cellspacing="0"
                   ...
                   <tbody>
                        <?php if (!empty($advance_salary)): ?>
                        <?php foreach ($advance_salary as $advance_salar): ?>
                        <tr>
                            <td><?= ($advance_salar['id']) ?></td>
                            <td><?= htmlspecialchars($advance_salar['name']) ?></td>
                            <td><?= htmlspecialchars($advance_salar['amount']) ?></td>
                            <td><?= htmlspecialchars($advance_salar['remarks']) ?></td>
                            <td><?= htmlspecialchars($advance_salar['created_at']) ?></td>
                            ...
                            <td class="space-x-2">
                                ...
                                <form class="inline-block" method="POST">
                                    ...
                                    <input type="hidden" name="id" value="<?= $advance_salar['id'] ?>">
                                    <button
                                ...
                                <!-- Update Button -->
                                <a href="/advance_salary/edit?id=<?= $advance_salar['id'] ?>"

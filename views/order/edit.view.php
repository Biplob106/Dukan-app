                ...
                <div class="col-lg-8">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body p-4">
                            <form method="POST" action="/order/update" id="orderForm">
                                <!-- hidden order id-->
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="position-relative">
                                        <select name="customer_id" id="customer_id" class="form-select form-select-lg" required style="padding-right: 50px;">
                                            ...
                                            <?php
                                            $selectedCustomer = $old['customer_id'] ?? $order['customer_id'] ?? null;
                                            ?>
                                            <?php foreach ($customers as $c): ?>
                                                <option value="<?php echo $c['id'] ?>" <?= ($selectedCustomer == $c['id']) ? 'selected' : '' ?>>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="number"
                                                step="0.01"
                                                name="discount"
                                                value="<?php echo htmlspecialchars($old['discount'] ?? $order['discount'] ?? 0) ?>"
                                                class="form-control"
                                                placeholder="0.00">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="date"
                                                name="delivery_date"
                                                value="<?php echo htmlspecialchars($old['delivery_date'] ?? date('Y-m-d', strtotime($order['delivery_date'])) ?? '') ?>"
                                                class="form-control">
                                        </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="remarks"
                                        ...
                                        rows="4"
                                        placeholder="Add any additional notes or special instructions..."><?php echo htmlspecialchars($old['remarks'] ?? $order['remarks'] ?? '') ?></textarea>

...
if($_SERVER['REQUEST_METHOD']=== 'POST'){
    ...
    if( $salary<0)
        ...
        if(!empty($errors))
            {
    return view('employee/create.view.php',[
...
$db->query(" INSERT INTO employees (name, email, phone, address, date_of_birth, nid_bc , date_of_joining , salary , night_salary , 
frequency , advance_salary) VALUES( :name , :email, :phone , :address, :date_of_birth , :nid_bc , :date_of_joining,
:salary, :night_salary, :frequency , :advance_salary)",
[
    'name' => $name,
    'email' => $email,
    'phone' => $phone,
